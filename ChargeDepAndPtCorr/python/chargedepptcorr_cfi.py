...
defaultCPDC = cms.EDAnalyzer('ChargeDepAndPtCorr', #Analyzer named: Correspond to the class name in 'plugin' folder
                             ...
                             #fname   = cms.untracked.InputTag("EffCorrectionsPixelPbPb_nominal.root"),
                             #fname   = cms.untracked.InputTag("EffCorrectionsPixelPbPb_tight.root"),
                             ...
                             isPix = cms.untracked.bool(True), #True Originally (pixel tracking)
                             pTmax_pix = cms.untracked.double(2.0), #2.4 original
                             nhitsmin_pix = cms.untracked.int32(3), #3 original
                             nhitsmax_pix = cms.untracked.int32(6),
                             chi2nmax_pix = cms.untracked.double(9.0),#12 nominal
                             dzdzerror_pix = cms.untracked.double(6.0), #8 nominal
